...
export default function TermsContent() {
  return (
    <article className="legal-doc">
      <p className="legal-doc-meta">시행일 : 2025년 7월 15일</p>

      <Article num="1" title="목적">
        <p>
          본 이용약관은 “태양라이프”(이하 “사이트”)의 서비스의 이용조건과 운영에 관한 제반 사항 규정을
          목적으로 합니다.
        </p>
      </Article>
      ...
      <Article num="2" title="용어의 정의">
        ...
        <ol className="legal-doc-clauses">
          <li>
          ...
          <li>
            회원 아이디(이하 “ID”) : 회원의 식별과 회원의 서비스 이용을 위하여 회원별로 부여하는
            고유한 문자와 숫자의 조합을 말합니다.
          </li>
          <li>
      ...
      <Article num="5" title="서비스 이용 신청">
        <ol className="legal-doc-clauses">
          ...
          <li>
            ...
            사이트 이용과 관련하여 아무런 권리를 주장할 수 없으며, 관계 법령에 따라 처벌받을 수
            있습니다.
          </li>
        </ol>
      </Article>

      <Article num="6" title="개인정보처리방침">
        <p>
          사이트 및 운영자는 회원가입 시 제공한 개인정보 중 비밀번호를 가지고 있지 않으며 이와 관련된
          부분은 사이트의 개인정보처리방침을 따릅니다.
        </p>
        <p>
          운영자는 관계 법령이 정하는 바에 따라 회원등록정보를 포함한 회원의 개인정보를 보호하기 위하여
          노력합니다.
        </p>
        <p>
        ...
        <p>
          운영자는 회원이 미풍양속에 저해되거나 국가안보에 위배되는 게시물 등 위법한 게시물을
          등록·배포할 경우 관련 기관의 요청이 있을 시 회원의 자료를 열람 및 해당 자료를 관련 기관에
          제출할 수 있습니다.
        </p>
      </Article>

      <Article num="7" title="운영자의 의무">
        <ol className="legal-doc-clauses">
          <li>
      ...
      <Article num="8" title="회원의 의무">
        <ol className="legal-doc-clauses">
          ...
          <li>
            이용고객은 아이디 및 비밀번호 관리에 상당한 주의를 기울여야 하며, 운영자나 사이트의 동의
            없이 제3자에게 아이디를 제공하여 이용하게 할 수 없습니다.
          </li>
      ...
      <Article num="9" title="서비스 이용 시간">
        ...
        <p className="legal-doc-label">사전 공지 없이 중단할 수 있는 경우</p>
        <ul>
        ...
        <ol className="legal-doc-clauses" start={3}>
          <li>
      ...
      <Article num="10" title="서비스 이용 해지">
        <ol className="legal-doc-clauses">
          <li>
      ...
      <Article num="11" title="서비스 이용 제한">
        <p>
      ...
      <Article num="12" title="게시물의 관리">
        <ol className="legal-doc-clauses">
          <li>
            사이트의 게시물과 자료의 관리 및 운영의 책임은 운영자에게 있습니다. 운영자는 항상 불량
            게시물 및 자료에 대하여 모니터링을 하여야 하며, 불량 게시물 및 자료를 발견하거나 신고를 받으면
            해당 게시물을 삭제하고 이를 등록한 회원에게 주의를 주어야 합니다. 한편, 이용회원이 올린
            게시물에 대해서는 게시자 본인에게 책임이 있으니 회원 스스로 본 이용약관에서 위배되는 게시물은
            게재해서는 안 됩니다.
          </li>
          <li>
        ...
        <p className="legal-doc-label">불량게시물 판단기준</p>
        <ul>
        ...
        <ol className="legal-doc-clauses" start={4}>
          <li>
            사이트 및 운영자는 게시물 등에 대하여 제3자로부터 명예훼손, 지적재산권 등의 권리 침해를
            이유로 게시중단 요청을 받은 경우 이를 임시로 게시 중단(전송중단)할 수 있으며, 게시중단
            요청자와 게시물 등록자 간에 소송, 합의 기타 이에 준하는 관련 기관의 결정 등이 이루어져
            사이트에 접수된 경우 이에 따릅니다.
          </li>
        </ol>
      </Article>

      <Article num="13" title="게시물의 보관">
        <p>
      ...
      <Article num="14" title="게시물에 대한 저작권">
        <ol className="legal-doc-clauses">
          <li>
      ...
      <Article num="15" title="손해배상">
        <ol className="legal-doc-clauses">
          <li>본 사이트의 발생한 모든 민, 형법상 책임은 회원 본인에게 1차적으로 있습니다.</li>
          <li>
            본 사이트로부터 회원이 받은 손해가 천재지변 등 불가항력적이거나 회원의 고의 또는 과실로
            인하여 발생한 때에는 손해배상을 하지 않습니다.
          </li>
        </ol>
      </Article>

      <Article num="16" title="면책">
        <ol className="legal-doc-clauses">
          <li>
          ...
          <li>
            운영자는 회원 상호 간 또는 회원과 제3자 상호 간에 서비스를 매개로 하여 물품거래 등을 한
          ...
          <li>
            ...
            또는 고의에 준하는 중대한 과실 없이 발생할 수 있는 시스템의 장애, 제3자의 공격으로 인한
            시스템의 장애, 국내외의 저명한 연구기관이나 보안 관련 업체에 의해 대응 방법이 개발되지 아니한
            컴퓨터 바이러스 등의 유포나 기타 운영자가 통제할 수 없는 불가항력적 사유로 인한 회원의
            손해에 대하여 책임지지 않습니다.
          </li>
        </ol>
      </Article>
      ...
      <section className="legal-doc-article">
        ...
        <p>이 약관은 2025년 7월 15일부터 시행합니다.</p>
      </section>
    </article>
  );
}
